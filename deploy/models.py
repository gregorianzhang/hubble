...
class server(models.Model):
    ...
    cpu_info = models.CharField(max_length=255, blank=True, null=True, unique=True, default=None)
    memory_info = models.CharField(max_length=255, blank=True, null=True, unique=True, default=None)
    disk_info = models.CharField(max_length=255, blank=True, null=True, unique=True, default=None)
...
class docker_images(models.Model):
    ...
    created = models.CharField(max_length=255, blank=True, null=True, unique=True, default=None)
    size = models.CharField(max_length=255, blank=True, null=True, unique=True, default=None)
...
class docker_containers(models.Model):
    ...
    command = models.CharField(max_length=255, blank=True, null=True, unique=True, default=None)
    created = models.CharField(max_length=255, blank=True, null=True, unique=True, default=None)
    status = models.CharField(max_length=255, blank=True, null=True, unique=True, default=None)
    ports = models.CharField(max_length=255, blank=True, null=True, unique=True, default=None)
